...
<g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
    ...
    <span class="app-brand-text demo menu-text fw-bolder ms-2">ادارة المكتبة</span>
  </a>
...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item">
    ...
    <li class="menu-item">
        <a href="/add_order" class="menu-link">
          <div data-i18n="اضافة طلب">اضافة طلب</div>
        </a>
      </li>
      <li class="menu-item">
  ...
  <li class="menu-item">
    ...
    <li class="menu-item">
        <a href="/add_author" class="menu-link">
          <div data-i18n="اضافة مؤلف">اضافة مؤلف</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="/authors" class="menu-link">
          <div data-i18n="عرض المؤلفيين">عرض المؤلفيين</div>
        </a>
      </li>
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="ملف تعريف المستخدم">ملف تعريف المستخدم</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
        <a href="/add_user_profile" class="menu-link">
          <div data-i18n="اضافة ملف تعريف للمستخدم">اضافة ملف تعريف للمستخدم</div>
        </a>
      </li>

      <li class="menu-item">
        <a href="/app-user_profile-list" class="menu-link">
          <div data-i18n="عرض الملف التعريفي للمستخدم" > عرض الملف التعريفي للمستخدم </div>
        </a>
      </li>
    </ul>
  </li>
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="التحقق من المستخدم">التحقق من المستخدم</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="/app-user_token-list" class="menu-link">
          <div data-i18n="عرض تحقق المستخدمين">عرض تحقق المستخدمين</div>
        </a>
      </li>
    </ul>
  </li>
