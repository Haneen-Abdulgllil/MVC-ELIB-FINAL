    ...
    <div class="offcanvas-body mx-0 flex-grow-0">
      <form class="add-new-user pt-0" id="addNewUserForm" onsubmit="return false">
        ...
        <div class="mb-3">
          ...
          <input type="text" id="add-user-email" class="form-control" placeholder="@example.com" aria-label="@example.com" name="userEmail" />
        </div>
        <div class="mb-3">
          <label class="form-label" for="add-user-contact">Contact</label>
          <input type="text" id="add-user-contact" class="form-control phone-mask" placeholder="+1 (609) 988-44-11" aria-label="@example.com" name="userContact" />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label class="form-label" for="country">البلاد</label>
...
<!-- /app-user-list , Sat, 26 Mar 2022 16:51:16 GMT -->
</html>
