...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>اضافة تحقق المستخدم</h4>
...
<div class="card mb-4">
  <form class="card-body" action="/" method="POST">
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-discount">التحقق</label>
        <input name="address" type="text" id="multicol-discount" class="form-control" placeholder="" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-phone">البلاد</label>
        <input name="country" type="text" id="multicol-phone" class="form-control" placeholder="" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-phone">الجهاز</label>
        <input name="device" type="text" id="multicol-phone" class="form-control" placeholder="" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-phone">OS</label>
        <input name="os" type="text" id="multicol-phone" class="form-control" placeholder="" />
      </div>
